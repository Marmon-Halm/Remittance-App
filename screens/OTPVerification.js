    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ alignItems: 'center' }}>
                ...
                <Text style={{ fontFamily: 'Manrope_600SemiBold', fontSize: 30, marginBottom: 20 }}> OTP VERIFICATION PAGE </Text>

                <TouchableOpacity style={styles.button} onPress={() => { navigation.navigate("UserPin") }}>
                    <Text style={styles.buttonText}>CLICK TO CREATE A USER PIN</Text>
                </TouchableOpacity>
            </View>
